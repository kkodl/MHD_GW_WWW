...
char Stop_ID [STOP_COUNT_TOTAL] [9];      // char array to store stop codes <<<<<<<<<<<BUG
...
void Ask_Golem (){
  ...
  String serverName = Gol_Server_Name + Stop_Ids + "&total=" + Number_Of_Trips + "&preferredTimezone=Europe%2FPrague&minutesBefore=-" + Walk_Time + "&minutesAfter=560";  // server address, must include querry
